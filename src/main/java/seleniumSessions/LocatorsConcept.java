...
//				System.out.println(header);
		...
		By warnmessage = By.className("alert");
		
		By continubtn = By.xpath("//*[@id=\"content\"]/form/div/div/input[2]");
		...
		String warngmessagevalue = doGetText(warnmessage);
		System.out.println(warngmessagevalue);
