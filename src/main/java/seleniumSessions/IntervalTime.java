...
//		ElementUtil eleUtil = new ElementUtil(driver);
		...
		//(By default it will try for 10 second(s) with 500 milliseconds interval)
//		eleUtil.waitForElementVisible(ytLink, 10).click();
		
		
		//(tried for 10 second(s) with 2000 milliseconds interval), here we can modify the time interval
