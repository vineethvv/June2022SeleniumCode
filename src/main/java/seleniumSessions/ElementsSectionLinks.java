...
public class ElementsSectionLinks {
	...
	public static void main(String[] args) {
		...
		// Here we are using Classname to capture the links of a particular section of a page.
		
		// If we want to capture all the links of the entire page then we use Tagname 'a'
