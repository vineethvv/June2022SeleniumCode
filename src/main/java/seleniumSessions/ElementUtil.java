...
public class ElementUtil {
	...
	// Here we made the driver as private to avoid another person to access it unnecessarily
	
	// In all Util class, the best practice is to made the driver as private always
	...
	//Note -  Here we have created the constructor to make the connection to this class driver from the WebElementHandling class driver.
